...
const OrderForm = ({ order, onSuccess, onCancel }: OrderFormProps) => {
  ...
  const { isValidating, validationResult, validateEmailAddress, clearValidation, showValidationMessage } = useEmailValidation();
  ...
  const handleChange = (field: string, value: string) => {
    ...
    // E-posta alanı değiştiğinde doğrulama durumunu sıfırla
  ...
  const handleEmailValidation = async () => {
    ...
    const result = await validateEmailAddress(formData.customer_email);
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    className={`pr-10 ${
                      formData.customer_email && validationResult
                ...
                {formData.customer_email && validationResult && !validationResult.isValid && (
                  <p className="text-sm text-red-600 mt-1">
                    {validationResult.error || 'Geçersiz e-posta adresi'}
                  </p>
                )}
              </div>
              <div>
